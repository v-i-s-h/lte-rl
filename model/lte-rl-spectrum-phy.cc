...
#include "lte-rl-spectrum-phy.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("LteRlSpectrumPhy");
...
NS_OBJECT_ENSURE_REGISTERED (LteRlSpectrumPhy);

LteRlSpectrumPhy::LteRlSpectrumPhy ()
  : m_state (IDLE),
    m_cellId (0),
...
void LteRlSpectrumPhy::DoDispose ()
{
  NS_LOG_FUNCTION (this);
  m_channel = 0;
  m_mobility = 0;
...
std::ostream& operator<< (std::ostream& os, LteRlSpectrumPhy::State s)
{
  switch (s)
    {
    case LteRlSpectrumPhy::IDLE:
      os << "IDLE";
      break;
    case LteRlSpectrumPhy::RX_DATA:
      os << "RX_DATA";
      break;
    case LteRlSpectrumPhy::RX_DL_CTRL:
      os << "RX_DL_CTRL";
      break;
    case LteRlSpectrumPhy::TX_DATA:
      os << "TX_DATA";
      break;
    case LteRlSpectrumPhy::TX_DL_CTRL:
      os << "TX_DL_CTRL";
      break;
    case LteRlSpectrumPhy::TX_UL_SRS:
      os << "TX_UL_SRS";
      break;
    default:
      os << "UNKNOWN";
...
LteRlSpectrumPhy::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::LteRlSpectrumPhy")
    ...
    .AddAttribute ("DataErrorModelEnabled",
                    ...
                    BooleanValue (true),
                   MakeBooleanAccessor (&LteRlSpectrumPhy::m_dataErrorModelEnabled),
                    MakeBooleanChecker ())
    .AddAttribute ("CtrlErrorModelEnabled",
                    ...
                    BooleanValue (true),
                    MakeBooleanAccessor (&LteRlSpectrumPhy::m_ctrlErrorModelEnabled),
                    MakeBooleanChecker ())
    .AddTraceSource ("DlPhyReception",
                     "DL reception PHY layer statistics.",
                     MakeTraceSourceAccessor (&LteRlSpectrumPhy::m_dlPhyReception),
                     "ns3::PhyReceptionStatParameters::TracedCallback")
    .AddTraceSource ("UlPhyReception",
                     "DL reception PHY layer statistics.",
                     MakeTraceSourceAccessor (&LteRlSpectrumPhy::m_ulPhyReception),
                     "ns3::PhyReceptionStatParameters::TracedCallback")
  ;
  return tid;
}
...
Ptr<NetDevice>
LteRlSpectrumPhy::GetDevice () const
{
  NS_LOG_FUNCTION (this);
  return m_device;
}
...
void
LteRlSpectrumPhy::SetDevice (Ptr<NetDevice> d)
{
...
void
LteRlSpectrumPhy::SetMobility (Ptr<MobilityModel> m)
{
...
void
LteRlSpectrumPhy::SetChannel (Ptr<SpectrumChannel> c)
{
...
Ptr<SpectrumChannel> 
LteRlSpectrumPhy::GetChannel ()
{
  return m_channel;
}

Ptr<const SpectrumModel>
LteRlSpectrumPhy::GetRxSpectrumModel () const
{
...
void
LteRlSpectrumPhy::SetTxPowerSpectralDensity (Ptr<SpectrumValue> txPsd)
{
...
void
LteRlSpectrumPhy::SetNoisePowerSpectralDensity (Ptr<const SpectrumValue> noisePsd)
{
...
void
LteRlSpectrumPhy::SetLtePhyRxDataEndErrorCallback (LtePhyRxDataEndErrorCallback c)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlSpectrumPhy::SetLtePhyRxDataEndOkCallback (LtePhyRxDataEndOkCallback c)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlSpectrumPhy::SetLtePhyRxCtrlEndOkCallback (LtePhyRxCtrlEndOkCallback c)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlSpectrumPhy::SetLtePhyRxCtrlEndErrorCallback (LtePhyRxCtrlEndErrorCallback c)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlSpectrumPhy::SetLtePhyRxPssCallback (LtePhyRxPssCallback c)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlSpectrumPhy::SetLtePhyDlHarqFeedbackCallback (LtePhyDlHarqFeedbackCallback c)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlSpectrumPhy::SetLtePhyUlHarqFeedbackCallback (LtePhyUlHarqFeedbackCallback c)
{
  NS_LOG_FUNCTION (this);
...
Ptr<AntennaModel>
LteRlSpectrumPhy::GetRxAntenna ()
{
  return m_antenna;
}

void
LteRlSpectrumPhy::SetAntenna (Ptr<AntennaModel> a)
{
...
void
LteRlSpectrumPhy::SetState (State newState)
{
...
void
LteRlSpectrumPhy::ChangeState (State newState)
{
...
void
LteRlSpectrumPhy::SetHarqPhyModule (Ptr<LteHarqPhy> harq)
{
...
bool
LteRlSpectrumPhy::StartTxDataFrame (Ptr<PacketBurst> pb, std::list<Ptr<LteControlMessage> > ctrlMsgList, Time duration)
{
  ...
  switch (m_state)
    ...
    case IDLE:
    {
      ...
      */
      ...
      m_endTxEvent = Simulator::Schedule (duration, &LteRlSpectrumPhy::EndTxData, this);
    }
    return false;
    break;
...
bool
LteRlSpectrumPhy::StartTxDlCtrlFrame (std::list<Ptr<LteControlMessage> > ctrlMsgList, bool pss)
{
  ...
  switch (m_state)
  {
    ...
    case IDLE:
    {
      ...
      */
      ...
      txParams->ctrlMsgList = ctrlMsgList;
      m_channel->StartTx (txParams);
      m_endTxEvent = Simulator::Schedule (DL_CTRL_DURATION, &LteRlSpectrumPhy::EndTxDlCtrl, this);
    }
    return false;
    break;
...
bool
LteRlSpectrumPhy::StartTxUlSrsFrame ()
{
  NS_LOG_FUNCTION (this);
  NS_LOG_LOGIC (this << " state: " << m_state);
  ...
  switch (m_state)
    ...
    case IDLE:
    {
      ...
      */
      ...
      txParams->cellId = m_cellId;
      m_channel->StartTx (txParams);
      m_endTxEvent = Simulator::Schedule (UL_SRS_DURATION, &LteRlSpectrumPhy::EndTxUlSrs, this);
    }
    return false;
    break;
...
void
LteRlSpectrumPhy::StartRx (Ptr<SpectrumSignalParameters> spectrumRxParams)
{
...
void
LteRlSpectrumPhy::StartRxData (Ptr<LteSpectrumSignalParametersDataFrame> params)
{
  NS_LOG_FUNCTION (this);
  switch (m_state)
    {
              ...
              if ((m_rxPacketBurstList.empty ())&&(m_rxControlMessageList.empty ()))
                {
                  ...
                  m_endRxDataEvent = Simulator::Schedule (params->duration, &LteRlSpectrumPhy::EndRxData, this);
                }
              else
                {
...
void
LteRlSpectrumPhy::StartRxDlCtrl (Ptr<LteSpectrumSignalParametersDlCtrlFrame> lteDlCtrlRxParams)
{
  NS_LOG_FUNCTION (this);
          ...
          if (cellId  == m_cellId)
            {
              ...
              m_endRxDlCtrlEvent = Simulator::Schedule (lteDlCtrlRxParams->duration, &LteRlSpectrumPhy::EndRxDlCtrl, this);
...
void
LteRlSpectrumPhy::StartRxUlSrs (Ptr<LteSpectrumSignalParametersUlSrsFrame> lteUlSrsRxParams)
{
  NS_LOG_FUNCTION (this);
  switch (m_state)
    {
            ...
            if (m_state == IDLE)
              {
                ...
                m_endRxUlSrsEvent = Simulator::Schedule (lteUlSrsRxParams->duration, &LteRlSpectrumPhy::EndRxUlSrs, this);
              }
...
void
LteRlSpectrumPhy::UpdateSinrPerceived (const SpectrumValue& sinr)
{
...
void
LteRlSpectrumPhy::AddExpectedTb (uint16_t  rnti, uint8_t ndi, uint16_t size, uint8_t mcs, std::vector<int> map, uint8_t layer, uint8_t harqId,uint8_t rv,  bool downlink)
{
...
void 
LteRlSpectrumPhy::SetCellId (uint16_t cellId)
{
  m_cellId = cellId;
}
...
void
LteRlSpectrumPhy::AddRsPowerChunkProcessor (Ptr<LteChunkProcessor> p)
{
  m_interferenceCtrl->AddRsPowerChunkProcessor (p);
}

void
LteRlSpectrumPhy::AddDataPowerChunkProcessor (Ptr<LteChunkProcessor> p)
{
  m_interferenceData->AddRsPowerChunkProcessor (p);
}

void
LteRlSpectrumPhy::AddDataSinrChunkProcessor (Ptr<LteChunkProcessor> p)
{
  m_interferenceData->AddSinrChunkProcessor (p);
}

void
LteRlSpectrumPhy::AddInterferenceCtrlChunkProcessor (Ptr<LteChunkProcessor> p)
{
  m_interferenceCtrl->AddInterferenceChunkProcessor (p);
}

void
LteRlSpectrumPhy::AddInterferenceDataChunkProcessor (Ptr<LteChunkProcessor> p)
{
  m_interferenceData->AddInterferenceChunkProcessor (p);
}

void
LteRlSpectrumPhy::AddCtrlSinrChunkProcessor (Ptr<LteChunkProcessor> p)
{
  m_interferenceCtrl->AddSinrChunkProcessor (p);
}

void 
LteRlSpectrumPhy::SetTransmissionMode (uint8_t txMode)
{
...
void 
LteRlSpectrumPhy::SetTxModeGain (uint8_t txMode, double gain)
{
...
int64_t
LteRlSpectrumPhy::AssignStreams (int64_t stream)
{
