...
#ifndef LTE_RL_ENB_NET_DEVICE_H
#define LTE_RL_ENB_NET_DEVICE_H
 ...
 */
class LteRlEnbNetDevice : public LteNetDevice
{
public:
  ...
  virtual ~LteRlEnbNetDevice (void);
   ...
   */
  Ptr<LteRlEnbPhy> GetPhy (void) const;
   ...
   *
   * \sa LteRlEnbNetDevice::SetCsgIndication
   */
...
private:
   ...
   * the LteRlEnbNetDevice from a user perspective, but are actually used also in
   ...
   * the LteRlEnbNetDevice.
   */
  void UpdateConfig ();

  Ptr<LteEnbMac> m_mac;

  Ptr<LteRlEnbPhy> m_phy;
...
}; // end of class LteRlEnbNetDevice
