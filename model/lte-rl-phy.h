...
public:
   ...
   */
  LteRlPhy (Ptr<LteRlSpectrumPhy> dlPhy, Ptr<LteRlSpectrumPhy> ulPhy);
   ...
   */
  Ptr<LteRlSpectrumPhy> GetDownlinkSpectrumPhy ();
   ...
   */
  Ptr<LteRlSpectrumPhy> GetUplinkSpectrumPhy ();
...
protected:
   ...
   */
  Ptr<LteRlSpectrumPhy> m_downlinkSpectrumPhy;
  /**
   ...
   */
  Ptr<LteRlSpectrumPhy> m_uplinkSpectrumPhy;
