...
#include "lte-rl-enb-phy.h"
#include "lte-rl-ue-phy.h"
#include <ns3/lte-net-device.h>
#include <ns3/lte-spectrum-value-helper.h>
#include <ns3/lte-control-messages.h>
#include "lte-rl-enb-net-device.h"
...
NS_LOG_COMPONENT_DEFINE ("LteRlEnbPhy");

NS_OBJECT_ENSURE_REGISTERED (LteRlEnbPhy);
...
{
public:
  EnbMemberLteEnbPhySapProvider (LteRlEnbPhy* phy);
...
EnbMemberLteEnbPhySapProvider::EnbMemberLteEnbPhySapProvider (LteRlEnbPhy* phy) : m_phy (phy)
{
...
LteRlEnbPhy::LteRlEnbPhy ()
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("This constructor should not be called");
}

LteRlEnbPhy::LteRlEnbPhy (Ptr<LteRlSpectrumPhy> dlPhy, Ptr<LteRlSpectrumPhy> ulPhy)
    ...
    m_interferenceSampleCounter (0)
{
  ...
  m_enbCphySapProvider = new MemberLteEnbCphySapProvider<LteRlEnbPhy> (this);
...
TypeId
LteRlEnbPhy::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::LteRlEnbPhy")
    .SetParent<LtePhy> ()
    .SetGroupName("Lte")
    .AddConstructor<LteRlEnbPhy> ()
    .AddAttribute ("TxPower",
                   "Transmission power in dBm",
                   DoubleValue (30.0),
                   MakeDoubleAccessor (&LteRlEnbPhy::SetTxPower, 
                                       &LteRlEnbPhy::GetTxPower),
    ...
    .AddAttribute ("NoiseFigure",
                   ...
                   DoubleValue (5.0),
                   MakeDoubleAccessor (&LteRlEnbPhy::SetNoiseFigure, 
                                       &LteRlEnbPhy::GetNoiseFigure),
                   MakeDoubleChecker<double> ())
...
LteRlEnbPhy::DoInitialize ()
{
  ...
  if (haveNodeId)
    {
      Simulator::ScheduleWithContext (nodeId, Seconds (0), &LteRlEnbPhy::StartFrame, this);
    }
  else
    {
      Simulator::ScheduleNow (&LteRlEnbPhy::StartFrame, this);
    }
...
void
LteRlEnbPhy::SetLteEnbPhySapUser (LteEnbPhySapUser* s)
{
  m_enbPhySapUser = s;
}

LteEnbPhySapProvider*
LteRlEnbPhy::GetLteEnbPhySapProvider ()
{
  return (m_enbPhySapProvider);
}

void
LteRlEnbPhy::SetLteEnbCphySapUser (LteEnbCphySapUser* s)
{
  NS_LOG_FUNCTION (this);
  m_enbCphySapUser = s;
}
...
LteRlEnbPhy::GetLteEnbCphySapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
LteRlEnbPhy::SetTxPower (double pow)
{
...
int8_t
LteRlEnbPhy::DoGetReferenceSignalPower () const
{
  NS_LOG_FUNCTION (this);
  return m_txPower;
}
...
void
LteRlEnbPhy::SetNoiseFigure (double nf)
{
...
double
LteRlEnbPhy::GetNoiseFigure () const
{
  NS_LOG_FUNCTION (this);
...
void
LteRlEnbPhy::SetMacChDelay (uint8_t delay)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
LteRlEnbPhy::GetMacChDelay (void) const
{
  return (m_macChTtiDelay);
}

Ptr<LteRlSpectrumPhy>
LteRlEnbPhy::GetDlSpectrumPhy () const
{
  return m_downlinkSpectrumPhy;
}

Ptr<LteRlSpectrumPhy>
LteRlEnbPhy::GetUlSpectrumPhy () const
{
  return m_uplinkSpectrumPhy;
}

bool
LteRlEnbPhy::AddUePhy (uint16_t rnti)
{
...
bool
LteRlEnbPhy::DeleteUePhy (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
  std::set <uint16_t>::iterator it;
  it = m_ueAttached.find (rnti);
...
void
LteRlEnbPhy::DoSendMacPdu (Ptr<Packet> p)
{
  NS_LOG_FUNCTION (this);
  SetMacPdu (p);
}
...
uint8_t
LteRlEnbPhy::DoGetMacChTtiDelay ()
{
  return (m_macChTtiDelay);
}
...
void
LteRlEnbPhy::PhyPduReceived (Ptr<Packet> p)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlEnbPhy::SetDownlinkSubChannels (std::vector<int> mask)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlEnbPhy::SetDownlinkSubChannelsWithPowerAllocation (std::vector<int> mask)
{
  NS_LOG_FUNCTION (this);
  m_listOfDownlinkSubchannel = mask;
...
std::vector<int>
LteRlEnbPhy::GetDownlinkSubChannels (void)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlEnbPhy::GeneratePowerAllocationMap (uint16_t rnti, int rbId)
{
  NS_LOG_FUNCTION (this);
...
Ptr<SpectrumValue>
LteRlEnbPhy::CreateTxPowerSpectralDensity ()
{
  NS_LOG_FUNCTION (this);
...
Ptr<SpectrumValue>
LteRlEnbPhy::CreateTxPowerSpectralDensityWithPowerAllocation ()
{
  NS_LOG_FUNCTION (this);
...
void
LteRlEnbPhy::CalcChannelQualityForUe (std::vector <double> sinr, Ptr<LteSpectrumPhy> ue)
{
  NS_LOG_FUNCTION (this);
}
...
void
LteRlEnbPhy::DoSendLteControlMessage (Ptr<LteControlMessage> msg)
{
...
void
LteRlEnbPhy::ReceiveLteControlMessage (Ptr<LteControlMessage> msg)
{
...
void
LteRlEnbPhy::ReceiveLteControlMessageList (std::list<Ptr<LteControlMessage> > msgList)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlEnbPhy::StartSubFrame (void)
{
  NS_LOG_FUNCTION (this);
  ...
  Simulator::Schedule (Seconds (GetTti ()),
                       &LteRlEnbPhy::EndSubFrame,
                       this);

}

void
LteRlEnbPhy::SendControlChannels (std::list<Ptr<LteControlMessage> > ctrlMsgList)
{
...
void
LteRlEnbPhy::SendDataChannels (Ptr<PacketBurst> pb)
{
...
void
LteRlEnbPhy::EndSubFrame (void)
{
  NS_LOG_FUNCTION (this << Simulator::Now ().GetSeconds ());
  if (m_nrSubFrames == 10)
    {
      Simulator::ScheduleNow (&LteRlEnbPhy::EndFrame, this);
    }
  else
    {
      Simulator::ScheduleNow (&LteRlEnbPhy::StartSubFrame, this);
    }
}


void
LteRlEnbPhy::EndFrame (void)
{
  NS_LOG_FUNCTION (this << Simulator::Now ().GetSeconds ());
  Simulator::ScheduleNow (&LteRlEnbPhy::StartFrame, this);
}
...
void 
LteRlEnbPhy::GenerateCtrlCqiReport (const SpectrumValue& sinr)
{
...
void
LteRlEnbPhy::GenerateDataCqiReport (const SpectrumValue& sinr)
{
...
void
LteRlEnbPhy::ReportInterference (const SpectrumValue& interf)
{
...
void
LteRlEnbPhy::ReportRsReceivedPower (const SpectrumValue& power)
{
  // not used by eNB
}
...
LteRlEnbPhy::CreatePuschCqiReport (const SpectrumValue& sinr)
{
  NS_LOG_FUNCTION (this << sinr);
...
void
LteRlEnbPhy::DoSetBandwidth (uint8_t ulBandwidth, uint8_t dlBandwidth)
{
...
void 
LteRlEnbPhy::DoSetEarfcn (uint16_t ulEarfcn, uint16_t dlEarfcn)
{
...
void 
LteRlEnbPhy::DoAddUe (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void 
LteRlEnbPhy::DoRemoveUe (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
LteRlEnbPhy::DoSetPa (uint16_t rnti, double pa)
{
  NS_LOG_FUNCTION (this << rnti);
...
FfMacSchedSapProvider::SchedUlCqiInfoReqParameters
LteRlEnbPhy::CreateSrsCqiReport (const SpectrumValue& sinr)
{
  NS_LOG_FUNCTION (this << sinr);
  Values::const_iterator it;
  FfMacSchedSapProvider::SchedUlCqiInfoReqParameters ulcqi;
...
void
LteRlEnbPhy::CreateSrsReport (uint16_t rnti, double srs)
{
...
void
LteRlEnbPhy::DoSetTransmissionMode (uint16_t  rnti, uint8_t txMode)
{
...
void
LteRlEnbPhy::QueueUlDci (UlDciLteControlMessage m)
{
  NS_LOG_FUNCTION (this);
...
void
LteRlEnbPhy::DoSetSrsConfigurationIndex (uint16_t  rnti, uint16_t srcCi)
{
  NS_LOG_FUNCTION (this);
...
void 
LteRlEnbPhy::DoSetMasterInformationBlock (LteRrcSap::MasterInformationBlock mib)
{
  NS_LOG_FUNCTION (this);
  m_mib = mib;
}
...
void
LteRlEnbPhy::DoSetSystemInformationBlockType1 (LteRrcSap::SystemInformationBlockType1 sib1)
{
  NS_LOG_FUNCTION (this);
  m_sib1 = sib1;
}
...
void
LteRlEnbPhy::SetHarqPhyModule (Ptr<LteHarqPhy> harq)
{
...
void
LteRlEnbPhy::ReceiveLteUlHarqFeedback (UlInfoListElement_s mes)
{
  NS_LOG_FUNCTION (this);
