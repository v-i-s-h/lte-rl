...
#ifndef ENB_RL_LTE_PHY_H
#define ENB_RL_LTE_PHY_H
 ...
 */
class LteRlEnbPhy : public LteRlPhy
{
  friend class EnbMemberLteEnbPhySapProvider;
  friend class MemberLteEnbCphySapProvider<LteRlEnbPhy>;
...
public:
   ...
   */
  LteRlEnbPhy (Ptr<LteRlSpectrumPhy> dlPhy, Ptr<LteRlSpectrumPhy> ulPhy);
